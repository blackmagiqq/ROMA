<template>
    <div class='row justify-content-center'>
        ...
        <div class='col-10'>
            <div class="row justify-content-center">
                <div class="col-auto">
                    <a class="nav-link" href="/v2#/app/insurance" target="_blank">Перейти в модуль</a>
                </div>
            </div>
...
<script>
    export default {
        ...
        methods: {
            append: function(){
                axios.post('api/admin/insurance/create', this.forAppend)
            ...
            remove: function(obj){
                axios.post('api/admin/insurance/delete', obj)
                .then(response => this.adminItems = response.data.data)
                .catch(err => {
                        this.$notify({
                        text: err.response.data.message,
            ...
            change: function(obj){
                axios.post('/api/admin/insurance/update', obj)
                .then(response => this.adminItems = response.data.data)
                .catch(err => {
                        this.$notify({
                        text: err.response.data.message,
        ...
        mounted() {
            axios.post('/api/admin/insurance/all')
